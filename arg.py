...
datasets = []
for (pos, neg) in [
    (df[df["verb_class"] == "verb_cls=47.2"], df[df["verb_class"] != "verb_cls=47.2"]),
...
name_to_set = {
    "probing_strong_train": datasets[0][0],
    "probing_strong_val": datasets[0][1],
    "probing_weak_train": datasets[1][0],
    "probing_weak_val": datasets[1][1],
    "test": datasets[0][1],
}
